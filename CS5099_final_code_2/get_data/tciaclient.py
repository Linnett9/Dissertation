...
#
class TCIAClient:
    """TCIA Client from TCIA REST API SDK GitHub. See
    https://github.com/TCIA-Community/TCIA-API-SDK. Updated to 
    Python 3 as part of this project. Provides functions 
    to make accessing the data hosted on The Cancer Imaging 
    Archive easier. 
    """
# Code adapted from the TCIAClient class
# Source: https://github.com/ExampleUser/tcia-client/blob/main/TCIAClient.py
# Author: cdmacfadyen
